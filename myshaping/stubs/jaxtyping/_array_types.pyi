...
Other = TypeVar("Other", bound="AbstractArray[_ArrayType, _Shape]")
Output = TypeVar("Output", bound="AbstractArray[_ArrayType, _Shape]")
class AbstractArray(Generic[_ArrayType, _Shape]):
    def __add__(self: Self, other: Other) -> Output: ...
    def __radd__(self: Self, other: Other) -> Output: ...
    def __iadd__(self: Self, other: Other) -> Self: ...
    def __sub__(self: Self, other: Other) -> Output: ...
    def __rsub__(self: Self, other: Other) -> Output: ...
    def __isub__(self: Self, other: Other) -> Self: ...
    def __mul__(self: Self, other: Other) -> Output: ...
    def __rmul__(self: Self, other: Other) -> Output: ...
    def __imul__(self: Self, other: Other) -> Self: ...
    # def __matmul__(self: Self, other: Other) -> Self: ...
    def __pow__(self: Self, other: Other) -> Output: ...
    def __ipow__(self: Self, other: Other) -> Self: ...
    def __sub__(self: Self, other: Other) -> Output: ...
    def __rsub__(self: Self, other: Other) -> Output: ...
    def __isub__(self: Self, other: Other) -> Self: ...
    def __mul__(self: Self, other: Other) -> Output: ...
    def __rmul__(self: Self, other: Other) -> Output: ...
    def __imul__(self: Self, other: Other) -> Self: ...
    def __matmul__(self: Self, other: Other) -> Output: ...
    def __div__(self: Self, other: Other) -> Output: ...
    def __truediv__(self: Self, other: Other) -> Output: ...
    def __rdiv__(self: Self, other: Other) -> Output: ...
    def __rtruediv__(self: Self, other: Other) -> Output: ...
    def __idiv__(self: Self, other: Other) -> Self: ...
    def __mod__(self: Self, other: Other) -> Output: ...
    def __neg__(self: Self) -> Self: ...
    def __eq__(self: Self, other: Other) -> "Bool[_ArrayType, _Shape]": ...
    def __ne__(self: Self, other: Other) -> "Bool[_ArrayType, _Shape]": ...
    def __lt__(self: Self, other: Other) -> "Bool[_ArrayType, _Shape]": ...
    def __le__(self: Self, other: Other) -> "Bool[_ArrayType, _Shape]": ...
    def __gt__(self: Self, other: Other) -> "Bool[_ArrayType, _Shape]": ...
    def __ge__(self: Self, other: Other) -> "Bool[_ArrayType, _Shape]": ...

    # FIXME: Mypy doesn't infer types correctly. (We hook them as a workaround)
    def half(self: Self) -> "Float16[_ArrayType, _Shape]": ...
    def bfloat16(self: Self) -> "BFloat16[_ArrayType, _Shape]": ...
    def float(self: Self) -> "Float32[_ArrayType, _Shape]": ...
    def double(self: Self) -> "Float64[_ArrayType, _Shape]": ...
    def short(self: Self) -> "Int16[_ArrayType, _Shape]": ...
    def int(self: Self) -> "Int32[_ArrayType, _Shape]": ...
    def long(self: Self) -> "Int64[_ArrayType, _Shape]": ...
